...
# se calcula el porcentaje de estudiantes trabajadores dividiendo los estudiantes trabajadores por el total de estudiantes
porcentaje_estudiantes_trabajadores = (
    estudiantes_trabajadores / total_trabajador
) * 100
# se calcula el porcentaje de estudiantes no trabajadores dividiendo los estudiantes trabajadores por el total de estudiantes
